...
class LJa extends L {
  ...
  @override
  String get energyExplain => '記録した摂取量から運動消費量を引いた値です。安静時や日常生活で使うエネルギーは含みません。';
  ...
  @override
  String get weightAdd => '体重を記録';

  @override
  String get weightFromHealth => 'ヘルスケアから読み込む';

  @override
  String get weightInvalid => '体重を確認してください。';

  @override
  String get weightRule => '1日に複数回測った場合はその日の最初の値を使います。測っていない日は空のままです。';

  @override
  String get trendsTitle => '記録と体の変化';
  ...
  String trendIntakeAvg(int n, int d) {
    ...
    return '記録した摂取の平均 ${nString}kcal · $d日';
  }
  ...
  String trendBurnedAvg(int n, int d) {
    ...
    return '運動消費の平均 ${nString}kcal · $d日';
  }
  ...
  String trendDiffAvg(int n, int d) {
    ...
    return '摂取 − 運動の平均 ${nString}kcal · 両方記録した$d日';
  }

  @override
  String trendIncomplete(int d) {
    return 'カロリー不明のある日 $d日 · 平均から除外';
  }

  @override
  String trendWeightChange(String a, String aw, String b, String bw) {
    return '測定体重は $a の $aw から $b の $bw に変わりました。';
  }

  @override
  String get trendWeightOne => '体重を測った日が1日だけです。変化を見るには別の日の測定が必要です。';

  @override
  String get trendWeightNone => 'この期間に測った体重はありません。';

  @override
  String get trendNoData => 'この期間の記録はありません。';
  ...
  @override
  String get diffLabel => '摂取 − 運動';

  @override
  String get weightMeasured => '体重（測定値）';

  @override
  String get sourceHealth => 'ヘルスケア';

  @override
  String get sourceManual => '手入力';

  @override
  String get burnedSource => '運動中にウォッチが計測したアクティブエネルギー';
