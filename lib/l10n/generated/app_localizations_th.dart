...
class LTh extends L {
  ...
  String queryLimit(String kind) {
    String _temp0 = intl.Intl.selectLogic(kind, {
      ...
      'measures': 'นับได้ครั้งละไม่เกิน 3 อย่าง ลองถามแยกเป็นส่วน',
      ...
      'groupedMeasure':
          'เมื่อจัดกลุ่มตามวัน สัปดาห์ เดือน หรือวันในสัปดาห์ นับได้เพียงอย่างเดียว และแนวโน้ม ครั้งล่าสุด ครั้งแรก และจำนวนวันตั้งแต่ครั้งล่าสุดจัดกลุ่มไม่ได้',
      'ordering':
