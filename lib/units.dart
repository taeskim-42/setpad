...
const _aliases = <String, String>{
  'kg': 'kg', '킬로': 'kg', 'kilo': 'kg', 'kilos': 'kg', 'キロ': 'kg',
  '公斤': 'kg', '千克': 'kg', 'kilogramo': 'kg', 'kilogramos': 'kg',
  'lb': 'lb', 'lbs': 'lb', '파운드': 'lb', 'pound': 'lb', 'pounds': 'lb',
  'ポンド': 'lb', '磅': 'lb', 'libra': 'lb', 'libras': 'lb',
  'km': 'km', '킬로미터': 'km', '公里': 'km', 'キロメートル': 'km',
  'm': 'm', '미터': 'm', '米': 'm', 'メートル': 'm', 'metro': 'm', 'metros': 'm',
  'mi': 'mi', 'mile': 'mi', 'miles': 'mi', '마일': 'mi', '英里': 'mi',
  's': 's', 'sec': 's', 'secs': 's', 'second': 's', 'seconds': 's',
  '초': 's', '秒': 's', 'segundo': 's', 'segundos': 's', 'giây': 's', 'วินาที': 's',
  'min': 'min', 'mins': 'min', 'minute': 'min', 'minutes': 'min',
  '분': 'min', '分': 'min', 'minuto': 'min', 'minutos': 'min', 'phút': 'min', 'นาที': 'min',
};
